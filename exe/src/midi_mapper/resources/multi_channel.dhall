  ...
  let config =
    {
      ...
      intervals = [
        lib.played_on_channel +0 (lib.direct_mapped_intervals (lib.note-range { channel = +1, from = +0, to = +12 })),
        lib.played_on_channel +0 (lib.direct_mapped_intervals (lib.note-range { channel = +2, from = -12, to = +12 }))
      ]
    }
