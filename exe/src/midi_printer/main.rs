...
#[command(
  ...
  version,
  about,
  long_about = "A virtual device that prints incoming MIDI messages and passes them through."
)]
pub struct Cli {}
...
impl MidiAction for Printer {
  fn midi_action<O>(&mut self, data: midi_mapper::midi_device::MidiData, mut outport: O)
  where
