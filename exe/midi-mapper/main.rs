...
fn main() -> Result<(), Box<dyn Error>> {
  ...
  let default_config: ConfigFile = serde_yaml::from_str(include_str!("resources/default_config.yaml"))?;
  ...
  let cli_config = ConfigFile { name: _name , profile: _profile, profiles: Profiles::default() };
